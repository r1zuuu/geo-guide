  ...
  return (
    <main className="p-6 max-w-3xl mx-auto">
      ...
      <p className="text-lg mb-6">
        <strong>
          Jeśli dopiero zaczynasz przygodę z GeoGuessr, ta sekcja jest dla Ciebie. Znajdziesz tu podstawowe porady, które pomogą Ci szybko rozpoznać kraj lub region.
        </strong>
      </p>
